...
<head>
  <meta charset="utf-8" />
  <title>Sweet Potato Bread - Misslaura</title>
...
<h1 class="title-swiper">Sweet Potato Bread</h1>
  ...
  <div class="swiper mySwiper" id="vertical">
    <div class="swiper-wrapper">
      ...
      $pastaEspecifica = './assets/images/produtos-ingles/sweet_potato_bread/';
      ...
      foreach ($imagens as $index => $imagem) {
        ...
        echo '<img class="main-image" src="' . $pastaEspecifica . $imagem . '" alt="Sweet Potato Bread" />';
        echo '</div>';
      }
      ?>
    </div>
