...
<head>
  <meta charset="utf-8" />
  <title>Pumpkin Bread - Misslaura</title>
...
<h1 class="title-swiper">Pumpkin Bread</h1>
  ...
  <div class="swiper mySwiper" id="vertical">
    <div class="swiper-wrapper">
      ...
      $pastaEspecifica = './assets/images/produtos-ingles/pumpkin_bread/';
      ...
      foreach ($imagens as $index => $imagem) {
        ...
        echo '<img class="main-image" src="' . $pastaEspecifica . $imagem . '" alt="Pumpkin Bread" />';
        echo '</div>';
      }
      ?>
    </div>
