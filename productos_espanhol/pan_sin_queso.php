...
<head>
  <meta charset="utf-8" />
  <title>Pan Sin Queso - Misslaura</title>
...
<h1 class="title-swiper">Pan Sin Queso</h1>
  ...
  <div class="swiper mySwiper">
    <div class="swiper-wrapper">
      ...
      foreach ($imagens as $index => $imagem) {
        ...
        echo '<img class="main-image" src="' . $pastaEspecifica . $imagem . '" alt="Pan Sin Queso" />';
        echo '</div>';
      }
      ?>
    </div>
  ...
  <!-- Thumbnails -->
    ...
    foreach ($imagens as $index => $imagem) {
      ...
      echo '<img class="swiper-thumb ' . $activeClass . '" src="' . $pastaEspecifica . $imagem . '" alt="Pan Sin Queso" data-index="' . $index . '" />';
    }
    ?>
  </div>
