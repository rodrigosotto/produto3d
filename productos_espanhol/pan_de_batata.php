...
<head>
  <meta charset="utf-8" />
  <title>Pan de Batata - Misslaura</title>
...
<h1 class="title-swiper">Pan de Batata</h1>
  ...
  <div class="swiper mySwiper" id="vertical">
    <div class="swiper-wrapper">
      ...
      $pastaEspecifica = '../assets/images/productos_es/pan_de_batata/';
      ...
      foreach ($imagens as $index => $imagem) {
        ...
        echo '<img class="main-image" src="' . $pastaEspecifica . $imagem . '" alt="Pan de Batata" />';
        echo '</div>';
      }
      ?>
    </div>
  ...
  <!-- Thumbnails -->
    ...
    foreach ($imagens as $index => $imagem) {
      ...
      echo '<img class="swiper-thumb ' . $activeClass . '" src="' . $pastaEspecifica . $imagem . '" alt="Pan de batata" data-index="' . $index . '" />';
    }
    ?>
  </div>
