...
<head>
  <meta charset="utf-8" />
  <title>Croquetas Maromba - Misslaura</title>
...
<h1 class="title-swiper">Croquetas Maromba</h1>
  ...
  <div class="swiper mySwiper">
    <div class="swiper-wrapper">
      ...
      $pastaEspecifica = '../assets/images/productos_es/croquetas_maromba/';
      ...
      foreach ($imagens as $index => $imagem) {
        ...
        echo '<img class="main-image" src="' . $pastaEspecifica . $imagem . '" alt="Croquetas Maromba" />';
        echo '</div>';
      }
      ?>
    </div>
