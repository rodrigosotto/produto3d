...
<head>
  <meta charset="utf-8" />
  <title>Empanadas Vegana de Hongos al Horno - Misslaura</title>
...
<h1 class="title-swiper">Empanadas Vegana de Hongos al Horno</h1>
  ...
  <div class="swiper mySwiper">
    <div class="swiper-wrapper">
      ...
      $pastaEspecifica = '../assets/images/productos_es/empanada_vegana_de_hongos_al_forno/';
      ...
      foreach ($imagens as $index => $imagem) {
        ...
        echo '<img class="main-image" src="' . $pastaEspecifica . $imagem . '" alt="Empanadas Vegana de Hongos al Horno" />';
        echo '</div>';
      }
      ?>
    </div>
  ...
  <!-- Thumbnails -->
    ...
    foreach ($imagens as $index => $imagem) {
      ...
      echo '<img class="swiper-thumb ' . $activeClass . '" src="' . $pastaEspecifica . $imagem . '" alt="Empanadas Vegana de Hongos al Horno" data-index="' . $index . '" />';
    }
    ?>
  </div>
