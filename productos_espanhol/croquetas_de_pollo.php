...
<head>
  <meta charset="utf-8" />
  <title>Croquetas de Pollo - Misslaura</title>
...
<h1 class="title-swiper">Croquetas de Pollo</h1>
  ...
  <div class="swiper mySwiper">
    <div class="swiper-wrapper">
      ...
      $pastaEspecifica = '../assets/images/productos_es/croquetas_de_pollo/';
      ...
      foreach ($imagens as $index => $imagem) {
        ...
        echo '<img class="main-image" src="' . $pastaEspecifica . $imagem . '" alt="Croquetas de Pollo" />';
        echo '</div>';
      }
      ?>
    </div>
  ...
  <!-- Thumbnails -->
    ...
    foreach ($imagens as $index => $imagem) {
      ...
      echo '<img class="swiper-thumb ' . $activeClass . '" src="' . $pastaEspecifica . $imagem . '" alt="croqueta de pollo" data-index="' . $index . '" />';
    }
    ?>
  </div>
