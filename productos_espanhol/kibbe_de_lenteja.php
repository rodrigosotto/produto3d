...
<head>
  <meta charset="utf-8" />
  <title>Kibbe de Lenteja - Misslaura</title>
...
<h1 class="title-swiper">Kibbe de Lenteja</h1>
  ...
  <div class="swiper mySwiper">
    <div class="swiper-wrapper">
      ...
      $pastaEspecifica = '../assets/images/productos_es/kibbe_de_lenteja/';
      ...
      foreach ($imagens as $index => $imagem) {
        ...
        echo '<img class="main-image" src="' . $pastaEspecifica . $imagem . '" alt="Kibbe de Lenteja" />';
        echo '</div>';
      }
      ?>
    </div>
  ...
  <!-- Thumbnails -->
    ...
    foreach ($imagens as $index => $imagem) {
      ...
      echo '<img class="swiper-thumb ' . $activeClass . '" src="' . $pastaEspecifica . $imagem . '" alt="Kibbe de lenteja" data-index="' . $index . '" />';
    }
    ?>
  </div>
