...
<head>
  <meta charset="utf-8" />
  <title>Empanadas de Pollo al Horno - Misslaura</title>
...
<h1 class="title-swiper">Empanadas de Pollo al Horno</h1>
  ...
  <div class="swiper mySwiper">
    <div class="swiper-wrapper">
      ...
      $pastaEspecifica = '../assets/images/productos_es/empanada_de_pollo_al_horno/';
      ...
      foreach ($imagens as $index => $imagem) {
        ...
        echo '<img class="main-image" src="' . $pastaEspecifica . $imagem . '" alt="Empanadas de Pollo al Horno" />';
        echo '</div>';
      }
      ?>
    </div>
