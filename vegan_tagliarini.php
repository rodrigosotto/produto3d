...
<head>
  <meta charset="utf-8" />
  <title>Vegan Tagliarini - Misslaura</title>
...
<h1 class="title-swiper">Vegan Tagliarini</h1>
  ...
  <div class="swiper mySwiper">
    <div class="swiper-wrapper">
      ...
      $pastaEspecifica = './assets/images/produtos-ingles/vegan_tagliarini/';
      ...
      foreach ($imagens as $index => $imagem) {
        ...
        echo '<img class="main-image" src="' . $pastaEspecifica . $imagem . '" alt="Vegan Tagliarini" />';
        echo '</div>';
      }
      ?>
    </div>
