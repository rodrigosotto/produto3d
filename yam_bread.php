...
<head>
  <meta charset="utf-8" />
  <title>Yam Bread- Misslaura</title>
...
<h1 class="title-swiper">Yam Bread</h1>
  ...
  <div class="swiper mySwiper" id="vertical">
    <div class="swiper-wrapper">
      ...
      $pastaEspecifica = './assets/images/produtos-ingles/yam_bread/';
      ...
      foreach ($imagens as $index => $imagem) {
        ...
        echo '<img class="main-image" src="' . $pastaEspecifica . $imagem . '" alt="Yam Bread" />';
        echo '</div>';
      }
      ?>
    </div>
