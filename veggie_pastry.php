...
<head>
  <meta charset="utf-8" />
  <title>Veggie Pastry - Misslaura</title>
...
<h1 class="title-swiper">Veggie Pastry</h1>
  ...
  <div class="swiper mySwiper">
    <div class="swiper-wrapper">
      ...
      $pastaEspecifica = './assets/images/produtos-ingles/veggie_pastry/';
      ...
      foreach ($imagens as $index => $imagem) {
        ...
        echo '<img class="main-image" src="' . $pastaEspecifica . $imagem . '" alt="Veggie Pastry" />';
        echo '</div>';
      }
      ?>
    </div>
