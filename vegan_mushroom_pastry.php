...
<head>
  <meta charset="utf-8" />
  <title>Vegan Mushroom Pastry - Misslaura</title>
...
<body>
<h1 class="title-swiper">Vegan Mushroom Pastry ou Empanadas Vegana de Hongos</h1>
  ...
  <div class="swiper mySwiper">
    <div class="swiper-wrapper">
      ...
      $pastaEspecifica = './assets/images/produtos-ingles/vegan_mushroom_pastry/';
      ...
      foreach ($imagens as $index => $imagem) {
        ...
        echo '<img src="' . $pastaEspecifica . $imagem . '" alt="Vegan Mushroom Pastry" />';
        echo '</div>';
      }
      ?>
    </div>
