...
<head>
  <meta charset="utf-8" />
  <title>Fitness Chicken Balls - Misslaura</title>
...
<h1 class="title-swiper">Fitness Chicken Balls</h1>
  ...
  <div class="swiper mySwiper">
    <div class="swiper-wrapper">
      ...
      $pastaEspecifica = './assets/images/produtos-ingles/fitness_chicken_balls/';
      ...
      foreach ($imagens as $index => $imagem) {
        ...
        echo '<img class="main-image" src="' . $pastaEspecifica . $imagem . '" alt="Fitness Chicken Balls" />';
        echo '</div>';
      }
      ?>
    </div>
