...
<head>
  <meta charset="utf-8" />
  <title>Sweet Potato Gnocchi - Misslaura</title>
...
<h1 class="title-swiper">Sweet Potato Gnocchi</h1>
  ...
  <div class="swiper mySwiper">
    <div class="swiper-wrapper">
      ...
      $pastaEspecifica = './assets/images/produtos-ingles/sweet_potato_gnocchi/';
      ...
      foreach ($imagens as $index => $imagem) {
        ...
        echo '<img class="main-image" src="' . $pastaEspecifica . $imagem . '" alt="Sweet Potato Gnocchi" />';
        echo '</div>';
      }
      ?>
    </div>
